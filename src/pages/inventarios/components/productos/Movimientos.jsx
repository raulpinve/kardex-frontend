import { obtenerCorteMovimientosProducto } from '../../services/movimientoServices';
...
const Movimientos = ({ corteId, productoId, tipoMovimiento = "lote"}) => {
    ...
    useEffect(() => {
        const fetchMovimientos = async () => {
            ...
            try {
                const respuesta = await obtenerCorteMovimientosProducto(token, corteId, productoId, tipo, fecha, paginaActual, debouncedConsulta);
                if (respuesta?.data) {
        ...
        fetchMovimientos();
    }, [tipoMovimiento, corteId, productoId, token, debouncedConsulta, paginaActual, tipo, fecha]);
