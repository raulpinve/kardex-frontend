...
const ListadoMovimientosProductosCorte = (props) => {
    ...
    const {productoId, corteId} = useParams();
    ...
    useEffect(() => {
        const fetchMovimientos = async () => {
            ...
            try {
                const respuesta = await obtenerMovimientosProductosCorte(corteId, productoId, tipo, fecha, paginaActual, debouncedConsulta);
                if (respuesta?.data) {
        ...
        fetchMovimientos();
    }, [corteId, productoId, debouncedConsulta, paginaActual, tipo, fecha]);
...
export default ListadoMovimientosProductosCorte;