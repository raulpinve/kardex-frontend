                ...
                <div className="w-full md:w-[700px]">
                    <Card>
                        <div>
                            ...
                            <p className='text-sm text-gray-700'>Para continuar, por favor selecciona un almacén: </p>
                        </div>
                        <div className='mt-3 text-sm text-gray-700'>

                            {/* Loading  */}
                            {loading && <>{
                                [...Array(5)].map(() => <div className="animate-pulse bg-slate-200 dark:bg-slate-700 rounded h-[25px] mb-3">
                                </div>)
                            }</>}
                            {/* Mostrando contenido */}
                            {!loading && (
                                <>
                                    ...
                                    <button 
                                        key={almacen.id} 
                                        className="block py-1 cursor-pointer hover:font-medium hover:text-black"
