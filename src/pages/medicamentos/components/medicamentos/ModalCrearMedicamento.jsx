...
import { crearMedicamento } from "../../services/medicamentosServices";

const ModalCrearMedicamento = (props) => {
    const { cerrarModal, setMedicamentos, almacenId} = props;
    ...
    const onSubmit = async(values) => {
        ...
        setLoading(true)
        try {
            const result = await crearMedicamento(token, {
                ...values,
                almacenId
            })
            const data = result?.data
            if(data){
                setMedicamentos(prevMedicamentos => [data, ...prevMedicamentos]);
                cerrarModal()
                setValue("nombre", "");
...
export default ModalCrearMedicamento;