...
const DropdownProfile = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <h3 className="font-medium text-sm text-gray-600 dark:text-white/90">Raúl Velásquez</h3>
        <h4 className="text-sm text-gray-500 dark:text-white/90">raulvelasquezpinto@gmail.com</h4>
